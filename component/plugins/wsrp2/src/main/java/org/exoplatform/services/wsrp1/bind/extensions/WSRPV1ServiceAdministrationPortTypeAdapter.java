 ...
 * Dec 15, 2008  
 */
public class WSRPV1ServiceAdministrationPortTypeAdapter {
  private static final Log LOG = ExoLogger.getLogger(WSRPV1ServiceAdministrationPortTypeAdapter.class);
  
  
  private WSRPV1ServiceAdministrationPortType serviceAdministrationPort;


  public WSRPV1ServiceAdministrationPortTypeAdapter(String address) {
//    String address = "http://localhost:8080/hello/soap/services/WSRP_v1_ServiceAdministration_Service";
    JaxWsProxyFactoryBean client = new JaxWsProxyFactoryBean();
    client.setServiceClass(WSRPV1ServiceAdministrationPortType.class);
    client.setAddress(address);
//    client.getInInterceptors().add(new LoggingInInterceptor());
//    client.getOutInterceptors().add(new LoggingOutInterceptor());
    Object obj = client.create();
    this.serviceAdministrationPort = (WSRPV1ServiceAdministrationPortType) obj;
  }
