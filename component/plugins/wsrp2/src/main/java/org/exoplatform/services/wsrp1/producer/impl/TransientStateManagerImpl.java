...
import org.exoplatform.services.wsrp.CacheControlProxy;
...
public class TransientStateManagerImpl implements TransientStateManager {
  ...
  private static final String TEMPLATE_KEY     = "org.exoplatform.services.wsrp1.templates.key";

  private static final String USER_CONTEXT_KEY = "org.exoplatform.services.wsrp1.user.context.key";
