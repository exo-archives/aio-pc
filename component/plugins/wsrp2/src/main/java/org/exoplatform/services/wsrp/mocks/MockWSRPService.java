...
/*
 * @author Mestrallet Benjamin benjmestrallet@users.sourceforge.net Date: 3
 * févr. 2004 Time: 02:59:48
 */
...
public class MockWSRPService extends WSRPServiceLocator implements WSRPService {
  ...
  /*
   * public Iterator getPorts() throws ServiceException { return null; //To
