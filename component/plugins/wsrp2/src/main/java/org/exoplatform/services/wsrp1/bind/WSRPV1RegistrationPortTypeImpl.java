...
/**
 * This class was generated by Apache CXF 2.1.2 Mon Dec 22 12:45:23 GMT+02:00
...
public class WSRPV1RegistrationPortTypeImpl implements WSRPV1RegistrationPortType {
  ...
  public void deregister(java.lang.String registrationHandle,
    ...
    try {
      ...
      ReturnAny response = registrationOperationsInterface.deregister(ws2registrationContext,
                                                                      null);
  ...
  public void register(java.lang.String consumerName,
    ...
    try {
      ...
      registrationData.getRegistrationProperties().addAll(WSRPTypesTransformer.getWS2Properties(registrationProperties));
      registrationData.getExtensions().addAll(WSRPTypesTransformer.getWS2Extensions(extensions.value));
