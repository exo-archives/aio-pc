...
//  }
  ...
  public void testGetServiceDescriptionWithPortletHandle() throws Exception {
    ...
    client.setAddress("http://localhost:8080/hello/soap/services/WSRP_v2_ServiceAdministration_Service");
    //WSRP_v2_ServiceAdministration_Service
    client.getInInterceptors().add(new LoggingInInterceptor());
    client.getOutInterceptors().add(new LoggingOutInterceptor());
    Object obj = client.create();
    WSRPV2ServiceAdministrationPortType serviceAdministarationPort = (WSRPV2ServiceAdministrationPortType) obj;
    System.out.println(">>> EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() serviceAdministarationPort = "
        + serviceAdministarationPort);
    System.out.println(">>>\n\n\n EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() 111 = " + 111);
    HashMap<String, String> hashMap = new HashMap<String,String>();
    javax.xml.ws.Holder<HashMap<String, String>> properties = new Holder<HashMap<String,String>>(hashMap);
    serviceAdministarationPort.getServiceAdministration(properties);
    System.out.println(">>> EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() hashMap = "
        + hashMap);
    System.out.println(">>> EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() hashMap.size() = "
        + hashMap.size());
    System.out.println(">>> EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() properties.value = "
        + properties.value);
    System.out.println(">>> EXOMAN TestGetServiceDescriptionInterface.testGetServiceDescriptionWithPortletHandle() properties.value.size() = "
