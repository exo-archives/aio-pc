...
public  class ContainerStarter {
  ...
  static boolean start(){
    ...
    try {
    Installer installer = new ZipURLInstaller(new java.net.URL("http://www.apache.org/dist/tomcat/tomcat-5/v5.5.25/bin/apache-tomcat-5.5.25.zip"), System.getProperty("java.io.tmpdir"));
    installer.install();
