 ...
 */
public class SetRenderParameterStringArrayIllegalArgumentExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SetRenderParameterStringArrayIllegalArgumentExceptionTest";
