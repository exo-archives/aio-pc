...
public class GetMaxInactiveIntervalTestPortlet extends GenericPortlet {

    public static String TEST_NAME = "GetMaxInactiveIntervalTest";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, java.io.IOException{
        ...
        if(result == expectedResult ) {
            ...
            resultWriter.addDetail( 
                "    PortletSession.getMaxInactiveInterval() returned " +
                " incorrect result." );
