...
/**
 * This class tests that if the variable name given to the renderURL
 * tag already exists in the scope of the page, the new value
 * overwrites the old one.
 */
public class RenderURLVarOverwriteTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = "RenderURLVarOverwriteTest";
    
    private final String SERVLET_NAME="RenderURLVarOverwriteTestServlet";
    ...
    public void render(RenderRequest request, RenderResponse response)
        ...
        if (requestCount.isFirstRequest()) {//create render portletURL
        ...
        else {//check that render parameter is set
