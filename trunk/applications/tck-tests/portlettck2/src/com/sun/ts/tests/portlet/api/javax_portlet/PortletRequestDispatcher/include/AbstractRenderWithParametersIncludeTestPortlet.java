 ...
 * the include() method in render() with render parameters set.
 * 
 ...
 */
public abstract class AbstractRenderWithParametersIncludeTestPortlet 
    ...
    public void render(RenderRequest request, RenderResponse response)
        ...
        if (reqCount.isFirstRequest()) {
        	//create renderURL with parameters
