...
public class URLClient extends BasePortletUrlClient {
	...
	*/
	public String getDefaultPortletApp() {
		return "portlet_jp_ReadOnlyException_web";
	}
    ...
    /*
     *   @testName:  ReadOnlyExceptionCtr1Test
     *   @assertion_ids: PORTLET:JAVADOC:270;
	 *   @test_Strategy: Construct a new instance of ReadOnlyException 
     *                  class with a string as argument. Test passes if the 
     *                  method getMessage() returns the argument string used 
     *                  during the construction of this instance.
	 *	 @assertion: Constructs a new read-only exception with the given 
     *              text. The portlet container may use the text write it to a 
     *              log.
     *
     */

    public void ReadOnlyExceptionCtr1Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                     getDefaultPortletApp(),
                                     "ReadOnlyExceptionCtr1TestPortlet");
    ...
    /*
     *   @testName:  ReadOnlyExceptionCtr2Test
     *   @assertion_ids: PORTLET:JAVADOC:271;
	 *   @test_Strategy: Construct a new instance of ReadOnlyException 
     *                  class with a string and Throwable object as arguments. 
     *                  Test passes if the methods getMessage() and getCause() 
     *                  returns the argument string (first argument) and a
     *                  Throwable object (second argument) respectively used
     *                  during the construction of this instance.
	 *	 @assertion: Constructs a new read-only exception when the portlet 
    ...
    public void ReadOnlyExceptionCtr2Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                     getDefaultPortletApp(),
                                     "ReadOnlyExceptionCtr2TestPortlet");
    ...
    /*
     *   @testName:  ReadOnlyExceptionCtr3Test
     *   @assertion_ids: PORTLET:JAVADOC:272;
	 *   @test_Strategy: Construct a new instance of ReadOnlyException 
     *                  class with a Throwable object as argument.
     *                  Test passes if the method getCause() returns a
     *                  Throwable object used during the construction of this
     *                  instance.
	 *	 @assertion: Constructs a new read-only exception when the portlet 
     *              needs to throw an exception. The exception message is based
     *              on the localized message of the underlying exception. 
     *
     */

    public void ReadOnlyExceptionCtr3Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                     getDefaultPortletApp(),
                                     "ReadOnlyExceptionCtr3TestPortlet");
