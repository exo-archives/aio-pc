 ...
 * tag is used within an iteration loop, the new value overwrites the
 * old one.
 */
public class RenderURLVarInLoopTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = "RenderURLVarInLoopTest";
    
    private final String SERVLET_NAME="RenderURLVarInLoopTestServlet";
