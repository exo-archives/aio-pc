...
public class GetParameterValuesTestPortlet extends GenericPortlet {
   ...
   public void processAction(ActionRequest request, ActionResponse response ) throws PortletException, IOException {
		...
		request.getPortletSession().setAttribute("GetParameterValuesResult",resultWriter.toString());
    }
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
        ...
        if (reqCount.isFirstRequest()) {
            ...
            out.println(request.getPortletSession().getAttribute("GetParameterValuesResult"));
        }
    }
