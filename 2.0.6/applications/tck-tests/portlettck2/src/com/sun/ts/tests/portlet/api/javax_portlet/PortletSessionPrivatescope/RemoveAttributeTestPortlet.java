...
public class RemoveAttributeTestPortlet extends GenericPortlet {
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, java.io.IOException {
        ...
        session.removeAttribute( "object", PortletSession.PORTLET_SCOPE );
        Object obj = session.getAttribute( "object", PortletSession.PORTLET_SCOPE );

        if(obj == null ) {
            resultWriter.setStatus(ResultWriter.PASS);
        } else {
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail( "     PortletSession.getAttribute(object, PortletSession.PORTLET_SCOPE) returned a non-null result" );
