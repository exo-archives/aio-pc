 ...
 */
public class SetRenderParameterStringAfterSendRedirectTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SetRenderParameterStringAfterSendRedirectTest";
    ...
    public void processAction(ActionRequest request,
        ...
        String location = request.getContextPath()
                          + "/SetRenderParameterStringAfterSendRedirectTest.html";
