...
public class CheckPortletURLGenerationListenerChainTest_2_Filter implements PortletURLGenerationListener {
	...
	public void filterResourceURL(ResourceURL url) {
		...
		if (paramMap.get("PortletURLGenerationFilter1") != null &&
			...
			url.setParameter("PortletURLGenerationFilter2", "true");
		}
	}
}
