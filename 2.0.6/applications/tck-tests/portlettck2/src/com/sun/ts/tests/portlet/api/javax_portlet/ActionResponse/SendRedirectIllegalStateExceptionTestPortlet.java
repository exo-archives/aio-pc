 ...
 * sendRedirect() method.
 */
public class SendRedirectIllegalStateExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SendRedirectIllegalStateExceptionTest";
    ...
    public void processAction(ActionRequest request,
        ...
        String location = request.getContextPath()
                          + "/RedirectedFailIllegalStateException.html";
        ...
        try {
            ...
            session.setAttribute(CommonConstants.ERROR_MESSAGE,
                                 ...
                                 + "ActionResponse.setRenderParameter() has "
                                 + "been called.");
