...
public class TestPublicParamPortlet2 extends GenericPortlet {
  ...
  protected void doView(RenderRequest renderRequest,
    ...
    w.println("<center><font size='3'><b><i>Portlet for test public paramethers. Linked to TestPublicParamPortlet1 and TestPublicParamPortlet3</i></b></font></center><br>");
    ...
    url.setParameter("public2", "-- from public2");
    url.setSecure(true);
