 ...
 * @version $Id: $
 */
public class TestUrlListenersPortlet1 extends GenericPortlet {
  ...
  public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
    ...
    w.println("<center><font size='3'><b><i>Portlet for test paramethers translating from URL through processAction into doView or serveResource.</i></b></font></center><br>");
    ...
    ResourceURL url1 = response.createResourceURL();
    w.println("<a href=\"");
    url1.write(w);
    w.println("\">resource url</a>");
  }

  public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException {
    response.setContentType("text/html");
    PrintWriter w = response.getWriter();
    w.println("Parameter \"paramFromListener1\": " + request.getParameter("paramFromListener1"));
  }
