...
public class PFConstants {
  ...
  public static final String LIST_COLLAPSED = "listCollapsed";
  public static final String PORTLETS_2_RENDER = "portlets2render";
  public static final String PORTLET_INFOS = "portletinfos";
