...
import org.exoplatform.services.portletcontainer.test.portlet2.MyEventPub;
...
public class EventDemo extends GenericPortlet {
  ...
  protected void doView(RenderRequest renderRequest, RenderResponse renderResponse)
    ...
    w.println("<center><font size='3'><b><i>The EventDemo is a portlet which can publish 'MyEventPub' event. This portlet and the HelloWorld process this event and change mode to edit.</i></b></font></center><br>");
