 ...
 * @version $Id: $
 */
public class HttpHeaderDemo extends GenericPortlet {
  ...
  protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
    ...
    w.println("<br/>Click to the link below to download a picture with Content-Disposition http header set to 'attachment; filename=picture.jpeg'<br/>");

    ResourceURL resourceURL = response.createResourceURL();
    w.println("<p><a href=\"" + resourceURL.toString() + "\">Click me</a></p>");
  }
