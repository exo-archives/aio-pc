...
public class ResourceDemo extends GenericPortlet {
  ...
  protected void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException,
    ...
    w.println("<b>The picture below is generated by the portlet itself at serveResource() method</b>");
    w.println("<br>");
  ...
  public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException,
    ...
    if (goal != null && goal.equals("image")) {
      ...
      w.println("<h3>Here's the markup got from <font color='red'>serveResource()</font></h3>");
    }
  }
