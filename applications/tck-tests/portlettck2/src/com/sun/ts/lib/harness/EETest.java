...
public abstract class EETest
    ...
    protected int iLogDelaySeconds = 1000;
    ...
    private Method getRunMethod (Class testClass) {
        ...
        try {
            ...
            runMethod = testClass.getMethod(sTestCase, null);
        } catch (NoSuchMethodException e) {
    ...
    private Method getCleanupMethod (Class testClass) {
        ...
        try {
            //get setup method
            cleanupMethod = testClass.getMethod(sTestCase + "_cleanup", null);
        } catch (NoSuchMethodException e) {
            //try calling the generic setup method
            try {
    ...
    /**
     * This method is only called when tests are run outside of JavaTest.
    ...
    protected void setTestStatus (Status s, Throwable t) {
        ...
        if (t != null) {
            if (t instanceof Fault) {
                //Only display fault stacktraces when tracing.
                TestUtil.logTrace("Exception at: ", ((Fault)t).e);
            } else {
        ...
        if (sTestCase == null || sTestCase.equals("")) {
            ...
            if (sTestStatus.getType() == Status.PASSED) {
                ...
                try {
                    ...
                    // "this" class.
                    if (nCl)
                        runMethod.invoke(testClInst, null);
                    else
            ...
            try {
                ...
                // "this" class.
                if (nCl)
                    cleanupMethod.invoke(testClInst, null);
                else
    ...
    private String[] getAllTestCases (Properties p) throws SetupException {
        ...
        try {
            ...
            throw  new SetupException("Failed while getting all test methods: " +
                    e.toString());
        }
    ...
    public static class Fault extends Exception {
         ...
         */
        public Fault (String msg, Exception e) {
            super(msg);
            this.e = e;
            //TestUtil.logErr(msg, e);
        }
