...
/**
 *  This class will test the constructor 
 *  ValidatorException(text, cause, failedKeys).
 */

public class ValidatorExceptionCtr2TestPortlet extends GenericPortlet {

	static public String TEST_NAME = "ValidatorExceptionCtr2Test";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
		...
		ValidatorException validatorException = 
             new ValidatorException(TEST_NAME, expectedCause, preferenceKeys);

        String message = validatorException.getMessage();
        Throwable cause = validatorException.getCause();
