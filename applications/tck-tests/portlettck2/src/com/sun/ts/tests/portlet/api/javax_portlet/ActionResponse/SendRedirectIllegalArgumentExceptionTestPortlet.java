 ...
 * sendRedirect() method.
 */
public class SendRedirectIllegalArgumentExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SendRedirectIllegalArgumentExceptionTest";

    public void processAction(ActionRequest request,
                              ActionResponse actionResponse)
        throws PortletException, IOException {

        String location = "RedirectedFailIllegalArgumentException.html";
        ...
        try {
            ...
            session.setAttribute(CommonConstants.ERROR_MESSAGE,
                                 ...
                                 + "when redirecting to a relative URL.");
