...
/**
 * This class tests the reset() method.
 */
public class ResetTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "ResetTest";
    ...
    public void render(RenderRequest request, RenderResponse response)
        ...
        if (bufferSize == 0) {  // no buffering is used
            ...
            resultWriter.addDetail("RenderResponse.reset() did not clear "
            ...
            if (continued) {
                // This failed result should be cleared by the reset()
                // call below.
                ...
                try {
                    ...
                    resultWriter.addDetail("RenderResponse.reset() "
                                           + "threw IllegalStateException.");
                }
            }
        } else {
