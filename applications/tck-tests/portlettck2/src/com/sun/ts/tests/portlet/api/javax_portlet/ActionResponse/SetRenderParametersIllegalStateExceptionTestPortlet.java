 ...
 */
public class SetRenderParametersIllegalStateExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SetRenderParametersIllegalStateExceptionTest";
    ...
    public void processAction(ActionRequest request,
        ...
        String location = request.getContextPath()
                          + "/SetRenderParametersIllegalStateExceptionTest.html";
