 ...
 */
public class RequestMethodsParameterMiscRenderIncludeTestPortlet 
	extends AbstractRenderWithParametersIncludeTestPortlet {
	
    private final String TEST_NAME = 
    	"RequestMethodsParameterMiscRenderIncludeTest";
