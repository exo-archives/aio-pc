 ...
 * Make a first request to the portlet and 
 * write a render PortletURL in the response object and then in
 * the second request
...
public class GetWindowStateTestPortlet extends GenericPortlet {
    ...
    public void computeResults(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        if ((result != null) && result.equals(WindowState.NORMAL)) {
            ...
            resultWriter.addDetail("Expected result = " + WindowState.NORMAL);
