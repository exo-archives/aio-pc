 ...
 */
public class ResourceURLVarInLoopTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = "ResourceURLVarInLoopTest";
    
    private final String SERVLET_NAME="ResourceURLVarInLoopTestServlet";
