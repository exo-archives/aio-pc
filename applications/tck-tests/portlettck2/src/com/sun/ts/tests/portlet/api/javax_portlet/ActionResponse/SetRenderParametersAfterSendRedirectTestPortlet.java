 ...
 * the IllegalStateException thrown by setRenderParameters() after
 * sendRedirect() has been called.
 */
public class SetRenderParametersAfterSendRedirectTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SetRenderParametersAfterSendRedirectTest";
    ...
    public void processAction(ActionRequest request,
        ...
        String location = request.getContextPath()
                          + "/SetRenderParametersAfterSendRedirectTest.html";

        actionResponse.sendRedirect(location);

        try {
            actionResponse.setRenderParameters(Collections.EMPTY_MAP);
