...
/**
 *	Test for WindowState.toString() method
 */
...
public class ToStringTestPortlet extends GenericPortlet {
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
        ...
        if (windowState.toString().equals("normal")) {
			resultWriter.setStatus(ResultWriter.PASS);
        } else {
			resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail("Expected WindowState.toString() : normal");
            resultWriter.addDetail("WindowState.toString() returned " 
