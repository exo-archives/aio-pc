...
/**
 * This class tests the getTitle() method.
 */
public class GetTitleTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "GetTitleTest";
    ...
    public void render(RenderRequest request, RenderResponse response)
        ...
        String result = getTitle(request);
