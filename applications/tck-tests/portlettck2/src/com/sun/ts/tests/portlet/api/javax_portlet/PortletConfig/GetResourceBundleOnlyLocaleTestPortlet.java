...
public class GetResourceBundleOnlyLocaleTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "GetResourceBundleOnlyLocaleTest";
    ...
    public void render(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        try {
            ...
            if (resourceBundle != null) {
                String expectedValue = "GetResourceBundleOnlyLocaleTestPortlet";
                String actualValue = 
