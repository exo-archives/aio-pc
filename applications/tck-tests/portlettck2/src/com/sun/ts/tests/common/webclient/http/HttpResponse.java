...
/*
 * @(#)HttpResponse.java	1.10 03/05/16
 */

/*
 * @(#)HttpResponse.java	1.5 08/20/02
 */
 ...
 */
    ...
    public String toString() {
        ...
        sb.append(((HttpMethodBase) _method).isHttp11() ? "HTTP/1.1 " : "HTTP/1.0 " );
        ...
        String resBody = _method.getResponseBodyAsString();
