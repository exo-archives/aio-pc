...
/**
 * This class tests that to any given time only one event
 * is processed.
 * 
...
public class CheckProcessOneEventTestPortlet extends GeneralEventing {
	
	public static final String TEST_NAME =
		"CheckProcessOneEventTest";
	...
	public void processEvent(EventRequest request, EventResponse response)
		...
		if (pass) {
			...
			resultWriter.addDetail("concurrent access on processEvent");
