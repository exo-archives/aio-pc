...
public class SetAttributeTestPortlet extends GenericPortlet {
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, java.io.IOException {
        ...
        String param = "object";
        String expectedResult = "Portlet";
        session.setAttribute( param, "JSP", PortletSession.PORTLET_SCOPE );
        session.setAttribute( param, expectedResult , PortletSession.PORTLET_SCOPE);
        String result =(String ) session.getAttribute( param , PortletSession.PORTLET_SCOPE);
