...
/**
 *  This class will test the constructor ValidatorException(cause, failedKeys).
 */

public class ValidatorExceptionCtr3TestPortlet extends GenericPortlet {

	static public String TEST_NAME = "ValidatorExceptionCtr3Test";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
		...
		ValidatorException validatorException = 
             new ValidatorException(expectedCause, preferenceKeys);
