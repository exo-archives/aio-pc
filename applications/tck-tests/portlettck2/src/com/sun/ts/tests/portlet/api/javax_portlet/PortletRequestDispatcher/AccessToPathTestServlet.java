...
/**
 * This class tests that a servlet being used from within an include
 ...
 */
public class AccessToPathTestServlet extends AbstractTestServlet {
    ...
    private void checkRequestUri(ServletRequest request,
        ...
        if ((result == null) || !result.equals(expectedResult)) {
            ...
            resultWriter.addDetail("javax.servlet.include.request_uri:");
    ...
    private void checkContextPath(ServletRequest request,
        ...
        if ((result == null) || !result.equals(expectedResult)) {
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail("javax.servlet.include.context_path:");
            resultWriter.addDetail("Expected result = " + expectedResult);
            resultWriter.addDetail("Actual result = " + result);
        }
    }
    ...
    private void checkServletPath(ServletRequest request,
        ...
        if ((result == null) || !result.equals(expectedResult)) {
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail("javax.servlet.include.servlet_path:");
            resultWriter.addDetail("Expected result = " + expectedResult);
            resultWriter.addDetail("Actual result = " + result);
        }
    }
    ...
    private void checkPathInfo(ServletRequest request,
        ...
        if ((result == null) || !result.equals(expectedResult)) {
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail("javax.servlet.include.path_info:");
            resultWriter.addDetail("Expected result = " + expectedResult);
            resultWriter.addDetail("Actual result = " + result);
        }
    }
    ...
    private void checkQueryString(ServletRequest request,
        ...
        if ((result == null) || !result.equals(expectedResult)) {
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail("javax.servlet.include.query_string:");
            resultWriter.addDetail("Expected result = " + expectedResult);
            resultWriter.addDetail("Actual result = " + result);
        }
    }
