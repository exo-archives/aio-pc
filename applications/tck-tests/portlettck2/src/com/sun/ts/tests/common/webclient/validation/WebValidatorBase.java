...
/*
 * @(#)WebValidatorBase.java	1.18 03/05/16
 */

/*
 * @(#)WebValidatorBase.java	1.18 05/16/03
 */
    ...
    public boolean validate(WebTestCase testCase) {
        ...
        try {
            if (!checkStatusCode() || !checkReasonPhrase()
                ...
                || !checkSearchStrings() || !checkUnorderedSearchStrings()
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i = 0,
                ...
                TestUtil.logTrace("[WebValidatorBase] Scanning response for " +
                    "seach string: '" + search + "' starting at index " +
                    "location: " + startIdx);
                if (searchIdx < 0) {
                    found = false;
