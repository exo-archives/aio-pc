...
/**
 * This class tests the IllegalStateException thrown by the reset() method.
 */
public class ResetIllegalStateExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "ResetIllegalStateExceptionTest";
