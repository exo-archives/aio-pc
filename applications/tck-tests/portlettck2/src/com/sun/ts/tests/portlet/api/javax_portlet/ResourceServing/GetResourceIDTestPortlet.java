...
public class GetResourceIDTestPortlet extends GenericPortlet {
	public static String TEST_NAME = "GetResourceIDTest";
	private static String resourceID = "resourceIDString";
