...
/**
 *	This class will test for PortletMode.VIEW
 */


public class CheckPortletModeViewTestPortlet extends GenericPortlet {

	static public String TEST_NAME = "CheckPortletModeViewTest";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
        ...
        if (portletMode != null) {
           if(portletMode.equals(PortletMode.VIEW)) {
              ...
              resultWriter.addDetail("Expected Portlet mode : view");
