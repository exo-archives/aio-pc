 ...
 */
public class RequestMethodsParameterMiscRenderForwardTestPortlet 
	extends AbstractRenderWithParametersForwardTestPortlet {
	
    private final String TEST_NAME = 
    	"RequestMethodsParameterMiscRenderForwardTest";
