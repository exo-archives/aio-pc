...
/**
 *  This class will test the constructor ReadOnlyException(cause).
 */

public class ReadOnlyExceptionCtr3TestPortlet extends GenericPortlet {

	static public String TEST_NAME = "ReadOnlyExceptionCtr3Test";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
		...
		ReadOnlyException readOnlyException = 
                    new ReadOnlyException(expectedCause);
