 ...
 * old one.
 */
public class ActionURLVarInLoopTestPortlet extends GenericPortlet {
	
    private final String TEST_NAME = "ActionURLVarInLoopTest";
    
    private final String SERVLET_NAME="ActionURLVarInLoopTestServlet";
