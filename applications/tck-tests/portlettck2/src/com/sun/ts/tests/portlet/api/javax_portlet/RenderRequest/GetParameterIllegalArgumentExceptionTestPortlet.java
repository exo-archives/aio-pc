 ...
 * getParameter() method.
 */
public class GetParameterIllegalArgumentExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "GetParameterIllegalArgumentExceptionTest";
