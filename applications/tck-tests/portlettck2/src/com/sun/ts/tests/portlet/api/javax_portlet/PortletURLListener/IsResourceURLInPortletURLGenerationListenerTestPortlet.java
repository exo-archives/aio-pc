...
public class IsResourceURLInPortletURLGenerationListenerTestPortlet extends GenericPortlet {
	public static final String TEST_NAME = "IsResourceURLInPortletURLGenerationListenerTest";
