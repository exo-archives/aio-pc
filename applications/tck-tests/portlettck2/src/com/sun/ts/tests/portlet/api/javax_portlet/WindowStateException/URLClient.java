...
public class URLClient extends BasePortletUrlClient {
	...
	*/
	public String getDefaultPortletApp() {
		return "portlet_jp_WindowStateException_web";
	}
    ...
    /*
     *   @testName:  WindowStateExceptionCtr1Test
     *   @assertion_ids: PORTLET:JAVADOC:311;PORTLET:JAVADOC:310;
	 *   @test_Strategy: Construct an instance of WindowStateException class 
     *                  with a string and a WindowState objects as arguments. 
     *                  Test passes if the methods getMessage() and getState()
     *                  returns the string(first argument) and the window state 
     *                  object (second argument) respectively that was used 
     *                  during the construction of this instance.
	 *	 @assertion: Constructs a new portlet state exception with the given 
     *              text. The portlet container may use the text write it to a 
     *              log.
     */

    public void WindowStateExceptionCtr1Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                       getDefaultPortletApp(),
                                       "WindowStateExceptionCtr1TestPortlet");
    ...
    /*
     *   @testName:  WindowStateExceptionCtr2Test
     *   @assertion_ids: PORTLET:JAVADOC:312;
	 *   @test_Strategy: Construct an instance of WindowStateException class 
     *                  with a string, Throwable and  WindowState objects 
     *                  as arguments. Test passes if the methods getMessage(), 
     *                  getCause() and getState() returns the string(first 
     *                  argument), a Throwable object (second argument) and 
     *                  the window state object (third argument) respectively 
     *                  that was used during the construction of this instance.
	 *	 @assertion: Constructs a new portlet state exception when the portlet 
     *              needs to do the following: throw an exception include a 
     *              message about the "root cause" that interfered with its 
     *              normal operation include a description message.
     *
     *
     */

    public void WindowStateExceptionCtr2Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                       getDefaultPortletApp(),
                                       "WindowStateExceptionCtr2TestPortlet");
    ...
    /*
     *   @testName:  WindowStateExceptionCtr3Test
     *   @assertion_ids: PORTLET:JAVADOC:313;
	 *   @test_Strategy: Construct an instance of WindowStateException class 
     *                  with Throwable and  WindowState objects as arguments. 
     *                  Test passes if the methods getCause() and getState() 
     *                  returns a Throwable object (for first argument) and 
     *                  the window state object (second argument) respectively 
     *                  that was used during the construction of this instance.
	 *	 @assertion: Constructs a new portlet state exception when the portlet 
     *               needs to throw an exception. The exception message is 
     *               based on the localized message of the underlying.
     *
     */

    public void WindowStateExceptionCtr3Test() throws Fault {
        /*
         * Sets the GET request to be sent out to the server.
         */
        TSPortletInfo portletInfo = new TSPortletInfo(
                                       getDefaultPortletApp(),
                                       "WindowStateExceptionCtr3TestPortlet");
