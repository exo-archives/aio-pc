 ...
 */
public class SetRenderParameterStringArrayIllegalStateExceptionTestPortlet extends GenericPortlet {
    public static final String TEST_NAME = "SetRenderParameterStringArrayIllegalStateExceptionTest";
    ...
    public void processAction(ActionRequest request,
        ...
        String location = request.getContextPath()
                          + "/SetRenderParameterStringArrayIllegalStateExceptionTest.html";

        actionResponse.sendRedirect(location);

        try {
            actionResponse.setRenderParameter(TEST_NAME, new String[0]);
