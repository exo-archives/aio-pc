...
public class CheckPortletURLGenerationListenerChainTest_1_Filter implements PortletURLGenerationListener{
	...
	public void filterResourceURL(ResourceURL url) {
		...
		if (paramMap.get("PortletURLGenerationFilter1") == null &&
			...
			url.setParameter("PortletURLGenerationFilter1", "true");
		}
	}
}
