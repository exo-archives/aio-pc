...
/**
 *  This class will test the setValue() method. 
 */

public class SetValueTestPortlet extends GenericPortlet {

    public static String TEST_NAME="SetValueTest";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
		...
		if (preferences != null) {
			// Set a new value
			preferences.setValue("preferredLanguage", "Java");

			// Try reading back the new value
