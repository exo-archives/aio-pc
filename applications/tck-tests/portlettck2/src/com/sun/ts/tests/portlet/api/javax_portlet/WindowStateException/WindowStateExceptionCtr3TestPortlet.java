...
/**
 *  This class will test the constructor WindowStateException(cause, state).
 */

public class WindowStateExceptionCtr3TestPortlet extends GenericPortlet {

	static public String TEST_NAME = "WindowStateExceptionCtr3Test";
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, IOException {
		...
		WindowStateException windowStateException = 
                new WindowStateException(expectedCause, windowState);
