...
public class GetAttributeNamesTestPortlet extends GenericPortlet {
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, java.io.IOException {
        ...
        Enumeration enumeration = session.getAttributeNames(PortletSession.PORTLET_SCOPE);
        ...
        if(enumeration.hasMoreElements() ) {
            ...
            while(enumeration.hasMoreElements() ) {
                ...
                if(name.equalsIgnoreCase( expectedResult1 ) ) {
                    if(!expectedResult1Found ) {
                        ...
                        resultWriter.addDetail( "    PortletSession.getAttributeNames(PortletSession.PORTLET_SCOPE) method return the same name twice" );
            ...
            if(count != expectedCount ) {
                resultWriter.setStatus(ResultWriter.FAIL);
                resultWriter.addDetail( "    PortletSession.getAttributeNames(PortletSession.PORTLET_SCOPE) method did not return the correct number of names " );
            ...
            resultWriter.setStatus(ResultWriter.FAIL);
            resultWriter.addDetail( "    PortletRequest.getAttributeNames(PortletSession.PORTLET_SCOPE) an empty enumeration " );
