...
/**
 * This class tests that the portlet-container provides an
 * implementation of the portlet tag library.
 */
public class PortletTaglibImplementedTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = 
		"PortletTaglibImplementedTest";
    
    private final String SERVLET_NAME = 
    	"PortletTaglibImplementedTestServlet";
