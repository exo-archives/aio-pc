...
/**
 * This class tests the var attribute of the resourceURL tag.
 * 
 * @author Oliver Spindler <olisp_suhl@yahoo.com>
 */
public class ResourceURLVarTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = "ResourceURLVarTest";
    
    private final String SERVLET_NAME="ResourceURLVarTestServlet";
