...
/**
 * 	A negative test for PortletSession.getAttribute(object, int) method
 */
...
public class GetAttributeNullTestPortlet extends GenericPortlet {
    ...
    public void render(RenderRequest request, RenderResponse response ) throws PortletException, java.io.IOException {
        ...
        Object value = session.getAttribute( "import javax.portlet.RenderRequest;", PortletSession.APPLICATION_SCOPE );
