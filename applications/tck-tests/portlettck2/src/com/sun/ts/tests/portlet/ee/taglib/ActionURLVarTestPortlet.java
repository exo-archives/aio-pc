...
/**
 * This class tests the var attribute of the actionURL tag.
 */
public class ActionURLVarTestPortlet extends GenericPortlet {
	
    private final String TEST_NAME = "ActionURLVarTest";
    
	private final String SERVLET_NAME="ActionURLVarTestServlet";
