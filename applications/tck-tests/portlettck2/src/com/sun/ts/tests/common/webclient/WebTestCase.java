...
/*
 * @(#)WebTestCase.java	1.14 03/05/16
 */

/*
 * @(#)WebTestCase.java	1.2 06/28/02
 */
 ...
 */
    ...
    public Header[] getExpectedHeaders() {
        ...
        return (Header[]) _expected.values().toArray(new Header[_expected.size()]);
    }
    ...
    public Header[] getUnexpectedHeaders() {
        ...
        return (Header[]) _unexpected.values().toArray(new Header[_unexpected.size()]);
    }
 ...
 */
    ...
    private void addHeader(Map map, String headerString) {
        ...
        while (st.hasMoreTokens()) {
            ...
            Header header = (Header) map.get(name);
            if (header != null) {
