 ...
 * not set for the renderURL tag.
 */
public class RenderURLPortletModeNotSetTestPortlet extends GenericPortlet {
	
	private final String TEST_NAME = "RenderURLPortletModeNotSetTest";
    
    private final String SERVLET_NAME="RenderURLPortletModeNotSetTestServlet";
