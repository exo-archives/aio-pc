...
/**
 *	A  Test for PortletRequest.getPortalContext()
 */


public class GetPortalContextTestPortlet extends LogicInProcessActionPortlet {

    public static String TEST_NAME="GetPortalContextTest";
    
    public void processAction(ActionRequest request, ActionResponse response) throws PortletException, IOException {

        ResultWriter resultWriter = new ResultWriter(TEST_NAME);

		if (request.getPortalContext() != null) {
