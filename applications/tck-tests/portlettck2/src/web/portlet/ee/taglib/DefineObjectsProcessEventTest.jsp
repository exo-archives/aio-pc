...
<% 
    String TEST_NAME = "DefineObjectsProcessEventTest";

	DefineObjectsVarComparator defineObjectsVarComparator = 
		new DefineObjectsVarComparator(TEST_NAME);
	
	defineObjectsVarComparator.checkEventRequest(request, eventRequest);
	defineObjectsVarComparator.checkEventResponse(request, eventResponse);
